...
public class VentanaModificarEmpleado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LetreroBuscarEmpleado = new javax.swing.JLabel();
        ...
        LetreroBuscarEmpleado.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        LetreroBuscarEmpleado.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        LetreroBuscarEmpleado.setText("Editar Empleado");
        jPanel1.add(LetreroBuscarEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 300, -1));
        ...
        botonEditar.setBackground(new java.awt.Color(0, 0, 153));
        ...
        jPanel1.add(botonEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 310, -1, -1));
    ...
    private void botonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEditarActionPerformed
        ...
        try{
            conexion = getConnection();
            ps = conexion.prepareStatement("update empleados set idEmpleado=?, Nombre=?, Contraseña=?, Edad=? where idEmpleado = ?");
            ps.setString(1, cajaIdEmpleado.getText());
            ps.setString(2, cajaNombre.getText());
            ps.setString(3, cajaContraseña.getText());
            ps.setString(4, cajaEdad.getText());
            ps.setString(5, cajaIdEmpleado.getText());
    ...
    private javax.swing.JLabel LetreroBuscarEmpleado;
