...
public class VentanaModificarUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LetreroBuscarUsuario.setText("Editar Usuario");
        ...
        jPanel1.add(botonEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 340, -1, -1));
    ...
    private void botonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEditarActionPerformed
        ...
        try{
            conexion = getConnection();
            ps = conexion.prepareStatement("update usuarios set idPersona=?, Nombre=?, Contraseña=?, Edad=?, Altura=?, Peso=? where idPersona = ?");
            ps.setString(1, cajaIdPersona.getText());
            ...
            ps.setString(7, cajaIdPersona.getText());
