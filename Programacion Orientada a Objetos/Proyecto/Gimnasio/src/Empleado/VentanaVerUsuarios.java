...
public class VentanaVerUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(botonCargarTabla, new org.netbeans.lib.awtextra.AbsoluteConstraints(236, 130, 100, -1));
        ...
        tablaUsuarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Contraseña", "Edad", "Altura", "Peso"
            }
        ) {
    ...
    private void botonCargarTablaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonCargarTablaActionPerformed
        ...
        try{
            ...
            ps = conexion.prepareStatement("select idPersona, Nombre, Contraseña, Edad, Altura, Peso from usuarios");
            rs = ps.executeQuery();
