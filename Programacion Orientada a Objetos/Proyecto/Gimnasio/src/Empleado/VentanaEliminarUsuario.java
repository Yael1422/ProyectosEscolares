...
public class VentanaEliminarUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        letreroEliminarUsuario = new javax.swing.JLabel();
        ...
        botonBuscarUsuario.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        ...
        jPanel1.add(botonBuscarUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 370, -1, -1));
        ...
        letreroEliminarUsuario.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        letreroEliminarUsuario.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        letreroEliminarUsuario.setText("Eliminar Usuario");
        jPanel1.add(letreroEliminarUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 300, -1));
        ...
        jPanel1.add(botonEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 340, -1, -1));
    ...
    private void botonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarActionPerformed
        ...
        try{
            conexion = getConnection();
            ps = conexion.prepareStatement("delete from usuarios where idPersona = ?");
            ps.setString(1, cajaIdPersona.getText());
    ...
    private javax.swing.JLabel letreroEliminarUsuario;
