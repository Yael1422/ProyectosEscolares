...
public class VentanaVerRutinaAP extends javax.swing.JFrame {
    ...
    private void botonVerRutinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonVerRutinaActionPerformed
        ...
        try{
            ...
            ps = conexion.prepareStatement("select Lunes, Martes, Miercoles, Jueves, Viernes from rutina where Utilidad='Aumentar Peso'");
            rs = ps.executeQuery();
