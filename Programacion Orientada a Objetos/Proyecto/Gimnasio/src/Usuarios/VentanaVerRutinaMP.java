...
public class VentanaVerRutinaMP extends javax.swing.JFrame {
    ...
    private void botonVerRutinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonVerRutinaActionPerformed
        ...
        try{
            ...
            ps = conexion.prepareStatement("select Lunes, Martes, Miercoles, Jueves, Viernes from rutina where Utilidad='Mantener Peso'");
            rs = ps.executeQuery();
